...
<template>
  <div class="components-container">
    <aside> <i class="el-icon-chat-line-round" /> 活动申诉处理界面</aside>
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="trialEventId" label="活动ID" />
  ...
  methods: {
    ...
    submit() {
      if (this.rowObject !== null) {
        request({
          url: `/cms/merchant-appeal`,
          method: 'post',
          data: {
            content: this.content,
            toUserAuthId: this.rowObject.fromUserAuthId,
            trialEventId: this.rowObject.trialEventId
          }
        })
          .then((data) => {
